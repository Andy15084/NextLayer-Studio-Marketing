        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <AnimatedOnScroll animation="fade-right">
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
              <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6 text-[#023047]">Where to Find Us</h2>
              
              {/* Phone */}
              <div className="mb-8">
                <div className="font-heading text-xl font-bold mb-2 text-[#023047]">Phone</div>
                <div className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                  </svg>
                  <a href="tel:+1234567890" className="font-mono text-lg hover:text-[#219EBC] transition-colors">
                    +1 (234) 567-890
                  </a>
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center">
                  ...
                  <a href="mailto:info@newwebsite.com" className="font-mono text-lg hover:text-[#219EBC] transition-colors">
                    info@newwebsite.com
                  </a>
                </div>
              </div>
              ...
              {/* Social Media */}
              <div>
                <div className="font-heading text-xl font-bold mb-4 text-[#023047]">Social Media</div>
          ...
          <AnimatedOnScroll animation="fade-left">
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
              <h2 className="font-heading text-3xl md:text-4xl font-bold mb-8 text-[#023047]">Contact Form</h2>
