      ...
      <div className="max-w-6xl mx-auto px-2 sm:px-4">
        ...
        <div className="flex justify-center mb-4">
          <div className="flex flex-wrap gap-6">
            ...
            {/* YouTube */}
            <a href="https://www.youtube.com/channel/UCDmSNQgXGdOCoYMDj-yaaWw" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
              <svg viewBox="0 0 24 24" width="24" height="24" className="text-white fill-current">
